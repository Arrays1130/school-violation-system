                ...
                <div class="p-8 space-y-8">
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="4" placeholder="Define the standard sanction for this violation..." required 
                            class="w-full px-4 py-3 bg-gray-50/50 border border-gray-200 text-gray-900 rounded-xl text-sm focus:bg-white focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all resize-none placeholder-gray-400">{{ old('description', $violation->description) }}</textarea>
                    </div>
