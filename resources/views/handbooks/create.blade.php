    ...
    <div class="max-w-3xl mx-auto space-y-8">
        ...
        <div class="relative overflow-hidden rounded-2xl bg-gradient-to-r from-slate-900 to-indigo-950 p-8 shadow-xl shadow-indigo-900/10 border border-indigo-900/20">
            ...
            <div class="relative flex items-center gap-5">
                <a href="{{ route('handbooks.index') }}" class="w-12 h-12 rounded-xl bg-white/10 border border-white/10 flex items-center justify-center text-white/80 hover:text-white hover:bg-white/20 transition-all shadow-sm backdrop-blur-md hover:-translate-x-0.5">
                ...
                <div>
                    ...
                    <h2 class="text-3xl font-bold text-white tracking-tight">Add Handbook Entry</h2>
                    <p class="text-indigo-100/70 text-sm mt-1">Publish new institutional rules and regulation guidelines.</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-gray-200/80 shadow-sm overflow-hidden">
            <form action="{{ route('handbooks.store') }}" method="POST">
                ...
                <div class="px-8 py-5 bg-gray-50 border-t border-gray-150 flex items-center justify-end gap-3">
                    <a href="{{ route('handbooks.index') }}" class="px-5 py-2.5 bg-white border border-gray-200 rounded-xl text-sm font-bold text-gray-700 hover:bg-gray-50 transition-all">
                        Cancel
                    </a>
