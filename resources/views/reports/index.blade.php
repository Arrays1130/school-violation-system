<x-app-layout>
    @section('header', 'Violation Reports')
                ...
                <table class="min-w-full divide-y divide-gray-150 text-left">
                    <thead>
                        <tr class="bg-gray-55/60">
                            <th scope="col" class="px-6 py-4.5 text-[10px] font-bold text-gray-400 uppercase tracking-wider">Date & Timestamp</th>
                            <th scope="col" class="px-6 py-4.5 text-[10px] font-bold text-gray-400 uppercase tracking-wider">Student Profile</th>
                            <th scope="col" class="px-6 py-4.5 text-[10px] font-bold text-gray-400 uppercase tracking-wider">Violation Details</th>
                            <th scope="col" class="px-6 py-4.5 text-[10px] font-bold text-gray-400 uppercase tracking-wider text-center">Lifecycle Status</th>
                            <th scope="col" class="px-6 py-4.5 text-[10px] font-bold text-gray-400 uppercase tracking-wider text-right font-medium">Record Action</th>
                        </tr>
                    </thead>
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-16 text-center">
                                    <div class="flex flex-col items-center justify-center text-gray-400 max-w-sm mx-auto">
                                        ...
                                        <h3 class="text-sm font-bold text-gray-900">No Violation Records Found</h3>
