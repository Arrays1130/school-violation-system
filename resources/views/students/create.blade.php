    ...
    <div class="max-w-4xl mx-auto space-y-8">
        ...
        <div class="relative overflow-hidden rounded-2xl bg-gradient-to-r from-slate-900 to-indigo-950 p-8 shadow-xl shadow-indigo-900/10 border border-indigo-900/20">
            ...
            <div class="relative flex items-center gap-5">
                <a href="{{ route('students.index') }}" class="w-12 h-12 rounded-xl bg-white/10 border border-white/10 flex items-center justify-center text-white/80 hover:text-white hover:bg-white/20 transition-all shadow-sm backdrop-blur-md hover:-translate-x-0.5">
                ...
                <div>
                    ...
                    <p class="text-indigo-100/70 text-sm mt-1.5">Register a new student profile in the system.</p>
                </div>
            </div>
        </div>
        ...
        <form action="{{ route('students.store') }}" method="POST">
            ...
            <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                <div class="p-8 space-y-10">
                    ...
                    <div class="space-y-6">
                        <div class="flex items-center gap-3 pb-4 border-b border-gray-100">
                            ...
                            <h3 class="text-sm font-bold text-gray-900 uppercase tracking-wider">Student Identification</h3>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <select name="year_level" required 
                                        class="w-full pl-10 pr-10 py-3 bg-gray-50/50 border border-gray-200 rounded-xl text-sm font-medium text-gray-900 focus:bg-white focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all appearance-none cursor-pointer">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="section" value="{{ old('section') }}" placeholder="e.g. BSIT 4A" required 
                                        class="w-full pl-10 pr-4 py-3 bg-gray-50/50 border border-gray-200 rounded-xl text-sm font-medium text-gray-900 focus:bg-white focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all placeholder-gray-400">
                    ...
                    <div class="space-y-6 pt-8 border-t border-gray-100">
                        <div class="flex items-center gap-3 pb-4 border-b border-gray-100">
                            ...
                            <h3 class="text-sm font-bold text-gray-900 uppercase tracking-wider">Emergency Contact</h3>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="guardian_phone" value="{{ old('guardian_phone') }}" placeholder="Primary Contact Number"
                                        class="w-full pl-10 pr-4 py-3 bg-gray-50/50 border border-gray-200 rounded-xl text-sm font-medium text-gray-900 focus:bg-white focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all placeholder-gray-400">
                ...
                <div class="px-8 py-5 bg-gray-50/80 border-t border-gray-100 flex items-center justify-between">
                    <a href="{{ route('students.index') }}" class="text-sm font-bold text-gray-500 hover:text-gray-900 transition-colors">Cancel</a>
