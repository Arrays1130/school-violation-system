                ...
                <div class="bg-white rounded-2xl border border-gray-200/80 shadow-sm p-6">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        <div class="text-center">
                            ...
                            <p class="text-[11px] text-gray-500 font-medium uppercase tracking-wider mt-1">Total</p>
                        </div>
                        <div class="text-center border-x border-gray-200">
                            <p class="text-3xl font-bold text-amber-600">{{ $offenseSummary['minor'] }}</p>
                            <p class="text-[11px] text-gray-500 font-medium uppercase tracking-wider mt-1">Minor</p>
                        </div>
                        <div class="text-center">
                            <p class="text-3xl font-bold text-red-600">{{ $offenseSummary['major'] }}</p>
                            <p class="text-[11px] text-gray-500 font-medium uppercase tracking-wider mt-1">Major</p>
                        </div>
                    </div>
                    {{-- Risk indicator --}}
                    @php
                    ...
                    <div class="mt-5 pt-4 border-t border-gray-200 flex items-center justify-between">
                        <span class="text-[11px] font-semibold text-gray-500 uppercase tracking-wider">Risk Level</span>
            ...
            <div class="lg:col-span-2 space-y-5">
                <div class="bg-white rounded-2xl border border-gray-200/80 shadow-sm overflow-hidden">
                    <div class="p-5 flex items-center justify-between gap-4 border-b border-gray-100 bg-gray-50/40">
                        <div class="min-w-0">
                            <h2 class="text-lg font-semibold text-gray-900 tracking-tight">Violation Timeline</h2>
                            <p class="text-sm text-gray-500 mt-1">Chronological record of this student’s disciplinary cases.</p>
                        </div>
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex gap-4 pb-6 last:pb-0 group">
                            ...
                            {{-- Content Card --}}
                            <div class="flex-1 bg-white rounded-2xl border border-gray-200/80 shadow-sm p-5 hover:border-indigo-200 hover:shadow-md transition-all duration-200 -mt-0.5">
                    ...
                    @empty
                        <div class="rounded-2xl border border-dashed border-gray-300 p-12 text-center bg-white">
                            ...
                            <p class="text-sm text-gray-500 mt-1.5 max-w-xs mx-auto">
                                No disciplinary records found. This student maintains an excellent behavioral record.
                            </p>
                            <a href="{{ route('cases.create', ['student_id' => $student->id]) }}"
