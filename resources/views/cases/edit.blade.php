    ...
    <div class="max-w-3xl mx-auto space-y-8">
        ...
        <div class="relative overflow-hidden rounded-2xl bg-gradient-to-r from-slate-900 to-indigo-950 p-8 shadow-xl shadow-indigo-900/10 border border-indigo-900/20">
            ...
            <div class="relative flex items-center gap-5">
                ...
                <div>
                    <h2 class="text-3xl font-bold text-white tracking-tight">Edit Case Record</h2>
                    <div class="flex items-center gap-3 mt-2">
                        ...
                        <span class="text-indigo-100/70 text-sm font-medium">Updating details for {{ $case->student->full_name }}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
            <form action="{{ route('cases.update', $case) }}" method="POST">
                ...
                <div class="p-8 space-y-8">
                    {{-- Status --}}
                    <div class="space-y-2">
                        <label class="block text-[11px] font-bold text-gray-500 uppercase tracking-wider mb-2">Case Status</label>
                        <div class="relative">
                    ...
                    <div class="space-y-2 pt-6 border-t border-gray-100">
                        <label class="block text-[11px] font-bold text-gray-500 uppercase tracking-wider mb-2">Incident Narrative</label>
                        <textarea name="description" rows="5" required placeholder="Provide a detailed description of the incident..."
                            class="w-full p-4 bg-gray-50/50 border border-gray-200 rounded-xl text-sm font-medium text-gray-900 focus:bg-white focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all resize-none placeholder-gray-400">{{ old('description', $case->description) }}</textarea>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6 border-t border-gray-100">
                        ...
                        <div>
                            <label class="block text-[11px] font-bold text-gray-500 uppercase tracking-wider mb-2">Witnesses (Optional)</label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-gray-400">
