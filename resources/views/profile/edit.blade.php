    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="relative overflow-hidden rounded-2xl bg-gradient-to-r from-slate-900 to-indigo-950 p-8 shadow-xl shadow-indigo-900/10 mb-8 border border-indigo-900/20">
            ...
            <div class="relative flex items-center gap-5">
                <a href="{{ route('dashboard') }}" class="w-12 h-12 rounded-xl bg-white/10 border border-white/10 flex items-center justify-center text-white/80 hover:text-white hover:bg-white/20 transition-all shadow-sm backdrop-blur-md hover:-translate-x-0.5">
                ...
                <div>
                    ...
                    <h2 class="text-3xl font-bold text-white tracking-tight">Profile Settings</h2>
                    <p class="text-indigo-100/70 text-sm mt-1.5">Manage your institutional credentials and security preferences.</p>
                </div>
            </div>
        </div>
