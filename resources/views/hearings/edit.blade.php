    ...
    <div class="max-w-4xl mx-auto space-y-8">
        ...
        <div class="relative overflow-hidden rounded-2xl bg-gradient-to-r from-slate-900 to-indigo-950 p-8 shadow-xl shadow-indigo-900/10 border border-indigo-900/20">
            ...
            <div class="relative flex items-center gap-5">
                <a href="{{ route('hearings.show', $hearing) }}" class="w-12 h-12 rounded-xl bg-white/10 border border-white/10 flex items-center justify-center text-white/80 hover:text-white hover:bg-white/20 transition-all shadow-sm backdrop-blur-md hover:-translate-x-0.5">
                ...
                <div>
                    ...
                    <h2 class="text-3xl font-bold text-white tracking-tight">Edit Hearing Details</h2>
                    <div class="flex items-center gap-3 mt-1.5">
                        ...
                        <span class="text-indigo-100/70 text-sm font-medium">{{ $hearing->case->violation->title }}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <form action="{{ route('hearings.update', $hearing) }}" method="POST">
            ...
            <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                <div class="p-8 space-y-8">
                    ...
                    <div class="pt-6 border-t border-gray-100">
                        ...
                        <textarea name="notes" rows="3" placeholder="Add any special instructions or notes for this hearing..."
                            class="w-full p-4 bg-gray-50/50 border border-gray-200 rounded-xl text-sm font-medium text-gray-900 focus:bg-white focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all resize-none placeholder-gray-400">{{ old('notes', $hearing->notes) }}</textarea>
                    ...
                    <div class="pt-6 border-t border-gray-100">
                        <div class="flex items-center gap-2 mb-3">
                            ...
                            <label class="block text-[11px] font-bold text-gray-500 uppercase tracking-wider">Minutes of Meeting</label>
                        </div>
                ...
                <div class="px-8 py-5 bg-gray-50/80 border-t border-gray-100 flex items-center justify-between">
                    <a href="{{ route('hearings.show', $hearing) }}" class="text-sm font-bold text-gray-500 hover:text-gray-900 transition-colors">Cancel</a>
