        ...
        <div class="relative overflow-hidden rounded-2xl bg-gradient-to-r from-slate-900 to-indigo-950 px-6 py-5 shadow-xl shadow-indigo-900/10 border border-indigo-900/20">
            ...
            <div class="relative flex items-center gap-5">
                ...
                <div>
                    ...
                    <h2 class="text-2xl font-bold text-white tracking-tight">Schedule Hearing</h2>
                    <div class="flex items-center gap-3 mt-1.5">
                        ...
                        <span class="text-indigo-100/70 text-xs font-medium">{{ $case->violation->title }}</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white/90 backdrop-blur-xl rounded-2xl ring-1 ring-slate-100/80 shadow-[0_4px_20px_rgb(0,0,0,0.03)] overflow-hidden">
                <div class="p-8 space-y-8">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="block text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-2">Date & Time *</label>
                            <div class="relative">
                    ...
                    <div class="pt-6 border-t border-gray-100">
                        <label class="block text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-2">Participants (Optional)</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400">
                            ...
                            <p class="text-xs text-slate-500 mt-2">Separate names with commas.</p>
                    ...
                    <div class="pt-6 border-t border-gray-100">
                        ...
                        <textarea name="notes" rows="3" placeholder="Additional instructions for the student..."
                            class="w-full p-4 bg-gray-50/50 border border-gray-200 rounded-xl text-sm font-medium text-slate-800 focus:bg-white focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all resize-none placeholder-gray-400">{{ old('notes') }}</textarea>
                    ...
                    <div class="pt-6 border-t border-gray-100">
                        <div class="flex items-center gap-2 mb-3">
                            ...
                            <label class="block text-[10px] font-bold text-slate-500 uppercase tracking-wider">Meeting Minutes (Initial)</label>
                        </div>
                        ...
                        <p class="text-xs text-slate-500 mt-2">You may leave this blank and formulate it securely during or after the hearing.</p>
                ...
                <div class="px-8 py-5 bg-gray-50/80 border-t border-gray-100 flex items-center justify-between">
                    <a href="{{ route('cases.show', $case) }}" class="text-sm font-bold text-slate-500 hover:text-slate-800 transition-colors">Cancel</a>
