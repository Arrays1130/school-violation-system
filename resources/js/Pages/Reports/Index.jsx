        ...
        >
            ...
            <PageMotion className="py-8">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                    ...
                    <MotionItem className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-slate-900 to-indigo-950 p-8 shadow-2xl shadow-indigo-900/20 mb-8 border border-indigo-900/50">
                    ...
                    {/* Search & Filters */}
                    <MotionItem className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl rounded-2xl p-5 border border-slate-200/60 dark:border-slate-700/60 shadow-sm">
                        <form onSubmit={handleSearch} className="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
                            ...
                            <div className="md:col-span-2 flex gap-2">
                                ...
                                <button type="button" onClick={clearFilters} className="px-4 py-2.5 bg-white dark:bg-slate-900 text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800 dark:bg-slate-800 rounded-xl flex items-center justify-center border border-slate-200 dark:border-slate-700 transition-all duration-200 active:scale-95" title="Clear Filters" aria-label="Clear filters">
                    ...
                    {/* Analytics Data List */}
                    <MotionItem className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl rounded-3xl border border-slate-200/60 dark:border-slate-700/60 shadow-sm overflow-hidden">
