...
export default function Login({ status, canResetPassword }) {
    ...
    return (
        <div className="min-h-screen flex flex-col justify-center items-center bg-cover bg-center relative" 
            ...
            <div className="z-10 w-full sm:max-w-md px-8 py-10 bg-white/40 backdrop-blur-md shadow-2xl overflow-hidden sm:rounded-[2rem] border border-white/40">
                ...
                <form onSubmit={submit}>
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                name="email"
                                value={data.email}
                                className="block w-full pl-10 pr-3 py-2.5 bg-white/60 border border-white/50 rounded-xl focus:ring-2 focus:ring-blue-500/50 focus:border-transparent text-gray-900 placeholder-gray-500 backdrop-blur-sm shadow-sm transition-all"
                    ...
                    <div className="mt-5">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                name="password"
                                value={data.password}
                                className="block w-full pl-10 pr-10 py-2.5 bg-white/60 border border-white/50 rounded-xl focus:ring-2 focus:ring-blue-500/50 focus:border-transparent text-gray-900 placeholder-gray-500 backdrop-blur-sm shadow-sm transition-all"
                                placeholder="••••••••"
                    ...
                    <div className="flex items-center justify-between mt-5 px-1">
                        <label className="flex items-center">
                            <input
                                ...
                                className="rounded border-gray-300 text-blue-600 shadow-sm focus:ring-blue-500 bg-white/70"
                            />
                    ...
                    <div className="mt-8 text-center text-xs font-medium text-gray-700 space-y-1">
                        <p>Secure login for authorized personnel only.</p>
                        <p><a href="#" className="hover:underline text-blue-800">Need technical assistance?</a></p>
                    </div>
                </form>
            </div>
        </div>
