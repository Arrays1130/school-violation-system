...
export default function DeanLogin({ status, canResetPassword }) {
        ...
        <div className="auth-screen flex min-h-[100dvh] w-full flex-col items-center justify-center px-4 py-8">
            ...
            >
                <div className="mb-6 flex flex-col items-center">
                    ...
                    <h2 className="text-3xl font-bold text-gray-900">Dean Portal</h2>
                    <p className="text-sm font-medium text-blue-700 mt-1">College Department Access</p>
                </div>
                ...
                <form onSubmit={submit}>
                    <div>
                        <label htmlFor="email" className="block text-sm font-semibold text-gray-700 ml-1 mb-1">Academic Email</label>
                    ...
                    <div className="flex items-center justify-between mt-5 px-1">
                        <label htmlFor="remember" className="flex items-center">
                            ...
                            />
                            <span className="ml-2 text-sm text-gray-700 font-medium">Stay signed in</span>
                        </label>
