...
import { ArrowLeft, UserPlus, Save, Shield, Key, Mail, User, Phone, Building2 } from 'lucide-react';
...
export default function Create({ auth, departments = [] }) {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 dark:text-slate-200 leading-tight">Create User</h2>}
        >
                    ...
                    <div className="relative flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                        <div className="flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <h2 className="text-3xl font-bold text-white tracking-tight">Create User Account</h2>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="pt-2">
                                            ...
                                            <label className="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-2 uppercase tracking-wider">Confirm Password</label>
                                            <div className="relative">
                                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-slate-400">
                                                    <Key className="w-4 h-4" />
                                                </div>
