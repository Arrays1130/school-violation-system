...
class SchoolMailerTest extends TestCase
{
    ...
    public function test_uses_smtp_when_credentials_are_configured(): void
    {
        ...
        Config::set('school.google_apps_script_url', null);
        ...
        $this->assertFalse(SchoolMailer::usesGoogleAppsScript());
    }

    public function test_prefers_apps_script_when_url_is_set(): void
    {
        Config::set('mail.default', 'smtp');
